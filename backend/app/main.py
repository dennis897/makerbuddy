...
from backend.app.api.routes import mv_files, mv_projects, mv_tags
...
# MakerVault file/project manager routes
app.include_router(mv_files.router)
app.include_router(mv_projects.router)
app.include_router(mv_tags.router)
